...
cpdefine("inline:com-chilipeppr-widget-myhomecnc", ["chilipeppr_ready", "CHART" /* other dependencies here */ ], function() {
    return {
        ...
        desc: "This This widget controls the different features and lasers of myhomecnc project.", // A description of what your widget does
        ...
        cncChartTest: function() {
            ...
            var ctx = $('#' + this.id + ' .object-temperature-chart').get(0).getContext("2d");
            var myLine = new this.CHART.Chart(ctx, config);
        },
