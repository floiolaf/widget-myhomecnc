...
cpdefine("inline:com-chilipeppr-widget-myhomecnc", ["chilipeppr_ready", "Chart", "socketio", "bootstrapSlider", /* other dependencies here */ ], function(chilipeppr_ready, Chart, io, bootstrapSlider) {
    return {
        ...
        desc: "This widget interfaces the different features and devices of myHomeCNC project. It requires a special control board, different sensors, and all connected to a Raspberry Pi with a Server code in Python. External modules used : Socket.io, Chart.js and Bootstrap Slider", // A description of what your widget does
