...
cpdefine("inline:com-chilipeppr-widget-myhomecnc", ["chilipeppr_ready", "Chart", "socketio", "bootstrapSlider", /* other dependencies here */ ], function(chilipeppr_ready, Chart, io, bootstrapSlider) {
    return {
        ...
        desc: "This This widget controls the different features and devices of myhomecnc project. It requires a special board, different sensors connected to a Raspberry Pi and a Server code in Python. External modules used : Socket.io, Chart.js and Bootstrap Slider", // A description of what your widget does
